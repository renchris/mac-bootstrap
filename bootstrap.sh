...
BOOTSTRAP_MODULE_ORDER="agent_cli github_cli statusline instructions skills hooks reporting_off handoff microsoft365 microsoft365_archive shared_folders pane_equalize voiceink rewrite_model screenshot browser_automation extra_agents"
