...
BOOTSTRAP_MODULE_ORDER="agent_cli statusline instructions hooks reporting_off agent_env handoff microsoft365 microsoft365_archive shared_folders pane_equalize voiceink rewrite_model screenshot"
