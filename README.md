...
```bash
curl -fsSLo /tmp/mac-bootstrap.sh https://raw.githubusercontent.com/renchris/mac-bootstrap/0b3674db3ff11139f5252669353ed7a6c23944cd/bootstrap.sh && echo "ec2a362ae76fc1dc04271dd8d7acd2de8991766fc83046de62cc941362f75d51  /tmp/mac-bootstrap.sh" | shasum -a 256 -c - && bash /tmp/mac-bootstrap.sh
```
...
Replace `0b3674db3ff11139f5252669353ed7a6c23944cd` with the release commit — never `main`, whose
...
`ec2a362ae76fc1dc04271dd8d7acd2de8991766fc83046de62cc941362f75d51`; step 1 checks it,
...
1. FETCH — never pipe a script into a shell. Save it and check it; the check must print OK:
     curl -fsSL -o /tmp/mac-bootstrap.sh https://raw.githubusercontent.com/renchris/mac-bootstrap/0b3674db3ff11139f5252669353ed7a6c23944cd/bootstrap.sh
     echo "ec2a362ae76fc1dc04271dd8d7acd2de8991766fc83046de62cc941362f75d51  /tmp/mac-bootstrap.sh" | shasum -a 256 -c -
   If raw.githubusercontent.com cannot be reached, this is the one other source, under the same check:
     curl -fsSL -H 'Accept: application/vnd.github.raw' -o /tmp/mac-bootstrap.sh 'https://api.github.com/repos/renchris/mac-bootstrap/contents/bootstrap.sh?ref=0b3674db3ff11139f5252669353ed7a6c23944cd'
   A third source serving the same bytes: https://cdn.jsdelivr.net/gh/renchris/mac-bootstrap@0b3674db3ff11139f5252669353ed7a6c23944cd/bootstrap.sh
